...
import { AppBar, Toolbar, Typography, Button, Avatar, Box, Switch, Container, Badge } from '@mui/material';
    ...
    return (
        <AppBar position="sticky" color="transparent" elevation={0} sx={{ top: 0 }}>
            <Container maxWidth="lg">
                <Toolbar sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', minHeight: { xs: 100, sm: 120, md: 140 }, py: 2 }}>
                    {BrandSection}
                    {NavLinks}
                </Toolbar>
            </Container>
